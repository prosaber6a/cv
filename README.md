...
CV is a resume and CV theme for Bootstrap created by CV Bootstrap. This theme features a fixed sidebar with content sections to build a simple, yet elegant resume.
